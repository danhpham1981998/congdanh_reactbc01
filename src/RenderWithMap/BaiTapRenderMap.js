...
export default class BaiTapRenderMap extends Component {
  dataFilm = [
    {
        ...
        "hinhAnh": "https://upload.wikimedia.org/wikipedia/vi/2/24/Ted_2_poster.jpg",
  ...
  //Viết hàm hiển thị danh sách phim dưới dạng div bootstrap
  renderFilm = () => {
    const arrTagFilm = this.dataFilm.map((phim, index) => {
      return (
        <div key={index} className="col-4 mt-2">
          <div className="card text-white bg-dark">
            <img width="300px" height="450px" className="card-img-top" src={phim.hinhAnh} alt={phim.hinhAnh} />
